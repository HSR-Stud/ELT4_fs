...
\begin{tabularx}{\columnwidth}{YY}
  ...
  \multicolumn{2}{c}{$\frac{Z}{R} = \frac{1}{1+j\Omega} = \frac{1}{\sqrt{1+\Omega^2}}
\phase{-\arctan{\Omega}}$} \\
...
2.~Polynomdivision ausführen & $\fmm \cn{F}(s) = \frac{2}{3}s + \frac{8s^4 + 48s^2 + 48}{3s^5 + 21s^3 + 30s}$ \\
...
\begin{tabular}{ccc}
  ...
  \begin{tabular}{l}
    \begin{circuitikz}[scale=0.5, transform shape]
      ...
      \draw (2,2) to [R, l={\Large $\cn{Z};\cn{Y}$}, *-*] (2,0);
    \end{circuitikz}
  \end{tabular} & 
  ...
  \begin{tabular}{l}
    \begin{circuitikz}[scale=0.5, transform shape]
      \draw (0,2) to [R, l_={\Large $\cn{Z}; \cn{Y}$}, o-o] (4,2);
      \draw (0,0) to [short, o-o] (4,0);
    \end{circuitikz}
  \end{tabular} & 
  ...
  \begin{tabular}{l}
    \begin{circuitikz}[scale=0.5, transform shape]
      \draw (0,2) to [R, l_={\Large $\cn{Z_1}$}, o-] (2,2) to [R, l_={\Large $\cn{Z_2}$}, -o] (4,2);
      \draw (0,0) to [short, o-o] (4,0);
      \draw (2,2) to [R, l={\Large $\cn{Z_3}$}, *-*] (2,0);
    \end{circuitikz}
  \end{tabular}} & 
  
  $\fmm \left[ \begin{array}{cc}
    \cn{Z_1} + \cn{Z_3} & \cn{Z_3} \\ \cn{Z_3} & \cn{Z_2} + \cn{Z_3}
  \end{array} \right] $ &
  
  $\fmm \frac{1}{\cn{Z_R}}\left[ \begin{array}{cc}
    \cn{Z_2} + \cn{Z_3} & -\cn{Z_3} \\ -\cn{Z_3} & \cn{Z_1} + \cn{Z_3}
  \end{array} \right] $ \\
  
  %$\fmm \left[ \begin{array}{cc}
  %  1 + \frac{\cn{Z_1}}{\cn{Z_3}} & \cn{Z_1} + \cn{Z_2} + \frac{\cn{Z_1} \cn{Z_2}}{\cn{Z_3}} \\
  %  \frac{1}{\cn{Z_3}} & 1 + \frac{\cn{Z_2}}{\cn{Z_3}}
  %\end{array} \right] $  \\ 
  &
  $\mathbf{A} = \left[ \begin{array}{cc} 
    ...
    \frac{1}{\cn{Z_3}} & 1 + \frac{\cn{Z_2}}{\cn{Z_3}} \\
  \end{array}  \right]$ & 
  $\cn{Z_R} = \cn{Z_1} \cn{Z_2} + \cn{Z_2} \cn{Z_3} + \cn{Z_1} \cn{Z_3}$ \\
\end{tabular}
...
\begin{tabular}{ccc}
  ...
  \begin{tabular}{l}
    \begin{circuitikz}[scale=0.5, transform shape]
      \draw (0,2) to [short, o-]  (1,2) to [R, l_={\Large $\cn{Z_3}$}] (3,2) to [short, -o] (4,2);
      \draw (0,0) to [short, o-o] (4,0);
      \draw (1,2) to [R, l_={\Large $\cn{Z_1}$}, *-*] (1,0);
      \draw (3,2) to [R, l^={\Large $\cn{Z_2}$}, *-*] (3,0);
      
    \end{circuitikz}
  \end{tabular} & 
    
  $\fmm \frac{1}{\cn{Z_R}} \left[ \begin{array}{cc}
    \cn{Z_1}(\cn{Z_2} + \cn{Z_3}) & \cn{Z_1} \cn{Z_2} \\ 
    \cn{Z_1} \cn{Z_2} & \cn{Z_2}(\cn{Z_1} + \cn{Z_3}) \\
  \end{array} \right] $ &
  ...
  \begin{tabular}{ll}
    \begin{tabular}{l}
      \begin{dtabular}
        ...
        $\alpha_R$ & Rückflussdämpfung $\left[ Np \right]$ \\
        $\cn{Z}_1$ & Leitungswiederstand am Anfang \\
        $\cn{Z}_2$ & Wiederstand nach der Leitung \\
        $\cn{P_{in}}$ & Leistung an der Quelle \\
        $\cn{P_{out}}$ & Leistung an der Last \\
      \end{dtabular} \\
      \begin{tabular}{cl}
        \midrule
    ...
    \begin{mtabular}{l}
      ...
      $\fmm \alpha_R = -\ln(r) \: Np = -20 \log_{10}(r) \: dB$ \\
      $\fmm \cn{U}_{v2} = \cn{U}_{v1} \cdot e^{-j \beta l}$ \\
      $\fmm P_v = \frac{U^2_{v1}}{Z_0} \qquad P_r = \frac{U^2_{r1}}{Z_0}$ \\
      $\fmm P_{v} = P_{in} \qquad P_{out} = P_{v} - P_{r}$
    \end{mtabular}\\
  \end{tabular}
\end{center}


\subsection{Quelle einer Leitung}

\begin{tabular}{ll}
  \begin{tabular}{l}
    \begin{circuitikz} [scale = 0.6, transform shape]
      \draw (2,0) to [short] (0,0) to [V, l={\Large $\cn{U_q}$}] (0,2) to [R, l={\Large $R_i$}] (2,2);
      \draw [ultra thick] (2,2) -- (6,2) (2,0) -- (6,0);
      \draw (6,2) to [short] (7,2) to [R, l={\Large $\cn{Z_L}$}] (7,0) to [short] (6,0);
      \draw (4,1) node {\Large $\cn{Z_0}$, $\gamma$, $l$};
    \end{circuitikz}
  \end{tabular}
  \begin{mtabular}{l}
    $\cn{U_1v} = \frac{\cn{Z_0}}{Z_0 + R_i} \cdot \cn{U_q} \stackrel{\tiny{R_i = Z_0}}{=} \frac{\cn{U_q}}{2}$ \\
    $\cn{U_1r} = \cn{r_1} \cdot U_{1v} \quad \cn{U_1} = \cn{U_{1r}} + \cn{U_{1v}}$ \\
    $\cn{I_1} = \cn{I_{1v}} - \cn{I_{1r}} = \frac{\cn{U_{1v}}}{\cn{Z_0}} - \frac{\cn{U_{1r}}}{\cn{Z_0}}$ 
  \end{mtabular}
\end{tabular}
...
Das \cdef{Stehwellenverhältnis $s$} (VSWR) ist das Verhältnis von Spannungsmaximum und -minimum.  
